...
const guideItems = [
  {
    ...
    content: (
      <div className="space-y-4">
        <div>
          <h5 className="font-semibold text-navy-900 mb-2">Heating</h5>
          <p className="text-navy-700/70 mb-3">
        ...
        <div className="border-t border-gold-100 pt-4">
          <h5 className="font-semibold text-navy-900 mb-2">Windows</h5>
          <p className="text-navy-700/70 mb-3">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div>
          <h5 className="font-semibold text-navy-900 mb-2">Lighting</h5>
          <p className="text-navy-700/70 mb-3">
            Most lights have dimmer switches. Slide the switch up to brighten or down to dim.
          </p>
        </div>
        <div className="border-t border-gold-100 pt-4">
          <h5 className="font-semibold text-navy-900 mb-2">Smart TV</h5>
          <p className="text-navy-700/70 mb-3">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div>
          <h5 className="font-semibold text-navy-900 mb-2">Appliances</h5>
          <ul className="space-y-2 text-navy-700/70">
        ...
        <div className="border-t border-gold-100 pt-4">
          <h5 className="font-semibold text-navy-900 mb-2">Help Yourself To</h5>
        ...
        <div className="border-t border-gold-100 pt-4">
          <h5 className="font-semibold text-navy-900 mb-2">Cleanup</h5>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div>
          <h5 className="font-semibold text-navy-900 mb-2">Shower</h5>
          <p className="text-navy-700/70 mb-3">
        ...
        <div className="border-t border-gold-100 pt-4">
          <h5 className="font-semibold text-navy-900 mb-2">Ventilation</h5>
          <p className="text-navy-700/70 mb-3">
            Turn on the ventilation fan during and after showers to prevent moisture buildup. The switch is on the wall.
          </p>
        </div>
        <div className="border-t border-gold-100 pt-4">
          <h5 className="font-semibold text-navy-900 mb-2">Heated Towel Rack</h5>
          <p className="text-navy-700/70">
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-gold-50 p-4 rounded border border-gold-200">
          <p className="text-sm text-navy-900 mb-2 font-semibold">Sorting Guide:</p>
          <ul className="text-sm text-navy-700/70 space-y-1">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div className="bg-white border-2 border-navy-600/20 rounded-lg p-6">
          <p className="text-sm text-navy-700/60 mb-2">Network Name (SSID):</p>
          <p className="text-lg font-mono text-navy-900 mb-4 font-semibold">
            AIRBNB GUESTS
          </p>
          <p className="text-sm text-navy-700/60 mb-2">Password:</p>
          <div className="flex items-center gap-3">
            <p className="text-lg font-mono text-navy-900 font-semibold">
            ...
            <button
              ...
              className="px-3 py-1 bg-gold-100 text-navy-700 text-sm font-medium rounded hover:bg-gold-200 transition-colors"
            >
              Copy
            </button>
          </div>
        </div>
        <div className="space-y-2 text-sm text-navy-700/70">
          ...
          <p className="text-navy-700/60">💡 If connection issues arise, restart the router (located under the kitchen counter).</p>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div>
          <h5 className="font-semibold text-navy-900 mb-2">Smoke Detectors</h5>
          <p className="text-navy-700/70">
            Smoke detectors are installed in the bedroom and living area. Please don't disable them.
          </p>
        </div>
        <div className="border-t border-gold-100 pt-4">
          <h5 className="font-semibold text-navy-900 mb-2">First-Aid Kit</h5>
          <p className="text-navy-700/70 mb-2">
            A well-stocked first-aid kit is in the bathroom cabinet for minor cuts and scrapes.
          </p>
        </div>
        <div className="border-t border-gold-100 pt-4">
          <h5 className="font-semibold text-navy-900 mb-2">Important Numbers</h5>
          <ul className="space-y-1 text-sm text-navy-700/70">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {guideItems.map((item) => (
            <div
              key={item.id}
              className="border border-gold-200 rounded-lg overflow-hidden hover:border-gold-300 transition-colors"
            >
              <button
                onClick={() => setOpenId(openId === item.id ? null : item.id)}
                className="w-full px-6 py-4 bg-white hover:bg-gold-50 transition-colors flex items-center justify-between text-left"
              >
                ...
                <svg
                  className={`w-6 h-6 text-navy-700 transition-transform ${
              ...
              {openId === item.id && (
                <div className="px-6 py-4 bg-gold-50/50 border-t border-gold-200 animate-in fade-in">
                  {item.content}
                </div>
              )}
            </div>
